      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        {currentStep === 1 && (
          <div className="space-y-4">
            ...
            <div>
              <Input
                {...register('firstName', { required: 'Firstname dibutuhkan!' })}
            ...
            <div>
              <Input
                {...register('lastName', { required: 'Lastname dibutuhkan!' })}
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            ...
            <div>
              <Input
                {...register('company', { required: 'Company harus jelas' })}
                placeholder="Company"
              />
              {errors.company && (
            ...
            <div>
              <Input
                {...register('position', { required: 'Position harus ada' })}
        ...
        {currentStep === 3 && (
          <div className="space-y-4">
            ...
            <div>
              <textarea
                {...register('bio', { required: 'Bio harus di isi!' })}
