...
function FunctionalUpdate() {
  ...
  const tambah = () => setCounter((prev) => prev + 1);
  const kurang = () => setCounter((prev) => prev - 1);

  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md text-center">
        <h1 className="text-2xl font-semibold mb-4 text-blue-600">Aplikasi Counter dengan Functional Update</h1>
